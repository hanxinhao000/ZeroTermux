 ...
 **/
public class FileListConfigDialog extends BaseDialogCentre {
    ...
    public FileListConfigDialog(@NonNull Context context) {
        super(context);
    }

    public FileListConfigDialog(@NonNull Context context, int themeResId) {
