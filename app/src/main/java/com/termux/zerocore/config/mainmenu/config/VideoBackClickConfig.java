...
public class VideoBackClickConfig extends BaseMenuClickConfig {
    @Override
    public int getType() {
    ...
    public Drawable getIcon(Context context) {
        return context.getDrawable(R.mipmap.video_img_menu);
    }

    @Override
    public String getString(Context context) {
        return context.getString(R.string.vedio_select_name);
    }
